...
class Aleap_Integrator_Model_Resource_Product extends Mage_Core_Model_Resource_Db_Abstract
{
    ...
    public static function assignMagentoProduct($target, $mp, $storeRootId = null)
    {
    ...
    /**
     * @param $mp Mage_Catalog_Model_Product
     * @param $store_root_id String
     * @return String[]
     */
    private static function categories($mp, $store_root_id = null)
    {
        ...
        if ($store_root_id) {
            $all_categories->addPathFilter("^1/$store_root_id/");
        }
    ...
    private static function variantAttributes($parent, $child, $parentAttributes, $pricesByAttributeValues, $parentImages)
    {
        ...
        if ($ht && $parent->getHandlingTime() != $child->getHandlingTime()) {
